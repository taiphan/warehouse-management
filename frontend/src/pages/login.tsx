...
const DEMO_USERS = [
  {
    ...
    description: 'Full access — manage devices, approve shipments, view analytics',
    icon: '👑',
  },
  {
    ...
    description: 'Approve/reject operations, manage inventory for APAC region',
    icon: '📋',
  },
  {
    ...
    description: 'Create import/export orders, process device shipments',
    icon: '🏭',
  },
];
